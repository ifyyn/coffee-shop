    ...
    <footer className="bg-amber-950 text-amber-100 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold text-white mb-4">COFFEE</h3>
            <p className="mb-4">
          ...
          <div>
            ...
            <form className="flex">
              <input
                ...
                className="px-4 py-2 rounded-l bg-amber-900 border border-amber-800 focus:outline-none focus:ring-1 focus:ring-amber-500 w-full"
              />
              <button
                type="submit"
                className="bg-amber-700 hover:bg-amber-600 text-white px-4 py-2 rounded-r"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-amber-800 mt-12 pt-8 text-center">
          <p>
            &copy; {new Date().getFullYear()} R'Coffee. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
